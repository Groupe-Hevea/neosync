...
<ThemedImage
  alt="Neosync header"
  sources={{
    light: 'https://assets.groupe-hevea.com/neosync/docs/neosync-header.svg',
    dark: 'https://assets.groupe-hevea.com/neosync/docs/neosync-header-dark.svg',
  }}
/>
...
We love contributors and are happy to accept PRs. The best way to contribute to Neosync is to go ahead and try out it. If you find something is not right, you can report an issue [here](https://github.com/Groupe-Hevea/neosync/issues/new?assignees=&labels=bug&template=bug_report.md).
